...
{
    public class CompilationUnitComposer : CompilationUnitSelector<CompilationUnitComposer>, RoseLib.ComposersOLD.IComposer
    {
        const string NODE_ANNOTATION_KIND = "RoseLibNewNode";
        public IComposer ParentComposer { get; set; }

        public CompilationUnitComposer(string path) : base(path)
        {
            Composer = this;
        }
        ...
        public void WriteChanges()
        {
            ...
            {
                streamWriter.Write(CurrentNode.NormalizeWhitespace().ToFullString());
            }
        }
    }
}
